...
/**
 * Request body to edit a user.
 */
public final class EditUserRequestBody {
	...
	/**
	 * EditUserRequestBody constructor.
	 *
	 ...
	 */
	public EditUserRequestBody(@JsonProperty("birthday") final LocalDate birthday,
